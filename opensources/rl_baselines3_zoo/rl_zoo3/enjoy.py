...
def enjoy() -> None:  # noqa: C901
    ...
    env.action_space = gym.spaces.Box(env.action_space.low, env.action_space.high, env.action_space.shape, env.action_space.dtype)
    env.observation_space = gym.spaces.Dict({
            k: gym.spaces.Box(
                low=env.observation_space[k].low,
                high=env.observation_space[k].high,
    ...
    try:
        ...
        for _ in generator:
            ...
            print(f'\r reward: {reward} | done: {done} | infos: {infos}', end='')
